...
namespace simulation
{
	public class SimId : IdList
	{
		...
		public const int SurroundingAgent = 2;
		public const int STKAgent = 3;
		public const int TechniciansAgent = 4;
		public const int MechanicsAgent = 5;
		public const int ModelManager = 101;
		public const int SurroundingManager = 102;
